...
<div class="guides-index-container">
    <div class="guides-index-card">
        ...
        <p class="guides-index-description">
            Welcome to Kabus Market. You can explore our comprehensive guides that we have prepared to help you better use our platform.
        </p>

        <div class="guides-index-grid">
            <div class="guides-index-item">
                <h3 class="guides-index-item-title">🌑 Kabus Market Guide ⛔</h3>
                <p class="guides-index-item-description">
                    Detailed information about the basic features and safe usage of Kabus Market.
                </p>
