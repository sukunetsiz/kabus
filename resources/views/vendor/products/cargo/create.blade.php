...
<div class="products-common-create-container">
    <div class="products-common-create-card">
        <div class="products-common-create-content">
            ...
            <form action="{{ route('vendor.products.cargo.store') }}" method="POST" class="products-common-create-form" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="products-common-create-option-card">
                            ...
                            <div class="products-common-create-field">
                                ...
                                <input type="text" 
                                    ...
                                    placeholder="e.g., Standard Delivery (3–5 business days via UPS), Express Shipping (1–2 business days via FedEx)"
                                    {{ $i === 0 ? 'required' : '' }}>
